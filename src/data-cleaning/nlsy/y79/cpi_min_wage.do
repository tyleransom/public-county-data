...
qui replace fedMinWage=7.25 if year==2018
qui replace fedMinWage=7.25 if year==2019
qui replace fedMinWage=7.25 if year==2020
qui replace fedMinWage=7.25 if year==2021
...
qui replace cpi=219.000 if year==2010
qui replace cpi=226.000 if year==2011
qui replace cpi=231.000 if year==2012
qui replace cpi=233.000 if year==2013
qui replace cpi=237.000 if year==2014
qui replace cpi=237.000 if year==2015
qui replace cpi=240.000 if year==2016
qui replace cpi=245.000 if year==2017
qui replace cpi=251.000 if year==2018
qui replace cpi=256.000 if year==2019
qui replace cpi=259.000 if year==2020
